...
%         stationManagement.knownUsedMatrixLTE = zeros(appParams.Nbeacons,simValues.maxID);
        ...
        stationManagement.ReserveRRPMatrix = zeros(appParams.NbeaconsT*appParams.NbeaconsF,int8(max(timeManagement.generationInterval)*10),simValues.maxID);
        stationManagement.knownRRPMatrix = zeros(appParams.NbeaconsT*appParams.NbeaconsF,int8(max(timeManagement.generationInterval)*10),simValues.maxID-1);
